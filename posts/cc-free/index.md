...
模型我们可以直接使用 Qwen3-Coder 和 GLM-4.5，如果需要添加其他的，我们可以在魔搭社区的模型库筛选可以免费使用的模型

![modelscope-models](modelscope-models.png)

以 glm 4.5 为例，进入模型详情页后复制模型 ID 填到 ccr ui 配置的模型列表中
...
- x-ai/grok-4-fast:free（这模型太快了，要速度有速度，要质量有速度）
...
下列配置是根据我个人使用情况总结出来的，请根据自己项目的实际情况选择

（不加参数说明默认为最大参数型号）

- 默认：glm 4.5、qwen3 coder (plus)、kimi k2 0905、deepseek v3.1、deepseek r1 0528
- 后台：qwen3 next 80B、qwen3 coder 30B、grok4 fast、gpt oss 120B、glm 4.5 air
- 思考：glm 4.5、deepseek v3.1、deepseek r1 0528
