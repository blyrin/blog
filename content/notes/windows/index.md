...
## 删除 Windows 11 中资源管理器左侧的主文件夹和图库
...
> Windows 10/11 的访问前缀规则参照 [RFC6724: Default Address Selection for Internet Protocol Version 6 (IPv6)](https://www.rfc-editor.org/rfc/rfc6724#section-2.1) 实现。可参考 [IANA IPv6 Special-Purpose Address Registry](https://www.iana.org/assignments/iana-ipv6-special-registry/iana-ipv6-special-registry.xhtml) 查看这些前缀的归属。
